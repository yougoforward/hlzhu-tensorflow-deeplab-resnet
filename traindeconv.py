...
from deeplab_resnet import DeepLabResNetModel, ImageReader, decode_labels, inv_preprocess, prepare_label, \
    DeepLabResNetModelarbiUp, DeepLabResNetModeldeconv
...
def main():
    ...
    # Create network.
    net = DeepLabResNetModeldeconv({'data': image_batch}, is_training=args.is_training, num_classes=args.num_classes)
    ...
    # Predictions.
    raw_output = net.layers['separate_deconv8']
    # Which variables to load. Running means and variances are not trainable,
    # thus all_variables() should be restored.
    restore_var = [v for v in tf.global_variables() if 'separate_deconv8' not in v.name]
