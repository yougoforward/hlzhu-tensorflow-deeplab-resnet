...
class DeepLabResNetModeledge(Network):
    def setup(self, is_training, num_classes):
        ...
        '''
        (self.feed('data')
         .sobel_layer(method='gray', name='gray_edge')
         .conv(7, 7, 64, 2, 2, biased=False, relu=False, name='edge_conv1')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn_edge_conv1')
         .max_pool(3, 3, 2, 2, name='pool1_edge')
         .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2a_edge_branch1')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn2a_edge_branch1'))

        (self.feed('pool1_edge')
         .conv(1, 1, 64, 1, 1, biased=False, relu=False, name='res2a_edge_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2a_edge_branch2a')
         .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2a_edge_branch2b')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2a_edge_branch2b')
         .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2a_edge_branch2c')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn2a_edge_branch2c'))

        (self.feed('bn2a_edge_branch1',
                   'bn2a_edge_branch2c')
         .add(name='res2a_edge')
         .relu(name='res2a_edge_relu')
         .conv(1, 1, 64, 1, 1, biased=False, relu=False, name='res2b_edge_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2b_edge_branch2a')
         .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2b_edge_branch2b')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2b_edge_branch2b')
         .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2b_edge_branch2c')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn2b_edge_branch2c'))

        (self.feed('res2a_edge_relu',
                   'bn2b_edge_branch2c')
         .add(name='res2b_edge')
         .relu(name='res2b_edge_relu')
         .conv(1, 1, 64, 1, 1, biased=False, relu=False, name='res2c_edge_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2c_edge_branch2a')
         .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2c_edge_branch2b')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn2c_edge_branch2b')
         .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2c_edge_branch2c')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn2c_edge_branch2c'))

        (self.feed('res2b_edge_relu',
                   'bn2c_edge_branch2c')
         .add(name='res2c_edge')
         .relu(name='res2c_edge_relu')
         .conv(1, 1, 512, 2, 2, biased=False, relu=False, name='res3a_edge_branch1')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn3a_edge_branch1'))

        (self.feed('res2c_edge_relu')
         .conv(1, 1, 128, 2, 2, biased=False, relu=False, name='res3a_edge_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3a_edge_branch2a')
         .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3a_edge_branch2b')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3a_edge_branch2b')
         .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3a_edge_branch2c')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn3a_edge_branch2c'))

        (self.feed('bn3a_edge_branch1',
                   'bn3a_edge_branch2c')
         .add(name='res3a_edge')
         .relu(name='res3a_edge_relu')
         .conv(1, 1, 128, 1, 1, biased=False, relu=False, name='res3b1_edge_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b1_edge_branch2a')
         .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b1_edge_branch2b')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b1_edge_branch2b')
         .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b1_edge_branch2c')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn3b1_edge_branch2c'))

        (self.feed('res3a_edge_relu',
                   'bn3b1_edge_branch2c')
         .add(name='res3b1_edge')
         .relu(name='res3b1_edge_relu')
         .conv(1, 1, 128, 1, 1, biased=False, relu=False, name='res3b2_edge_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b2_edge_branch2a')
         .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b2_edge_branch2b')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b2_edge_branch2b')
         .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b2_edge_branch2c')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn3b2_edge_branch2c'))

        (self.feed('res3b1_edge_relu',
                   'bn3b2_edge_branch2c')
         .add(name='res3b2_edge')
         .relu(name='res3b2_edge_relu')
         .conv(1, 1, 128, 1, 1, biased=False, relu=False, name='res3b3_edge_branch2a')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b3_edge_branch2a')
         .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b3_edge_branch2b')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn3b3_edge_branch2b')
         .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res3b3_edge_branch2c')
         .batch_normalization(is_training=is_training, activation_fn=None, name='bn3b3_edge_branch2c'))

        (self.feed('res3b2_edge_relu',
                   'bn3b3_edge_branch2c')
         .add(name='res3b3_edge')
         .relu(name='res3b3_edge_relu'))
...
class DeepLabResNetModeledgechannel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('data',
                   'gray_edge')
         .concat(axis=3, name='edge_concat')
         .conv(7, 7, 64, 2, 2, biased=False, relu=False, name='conv1')
         .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn_conv1'))
         .max_pool(3, 3, 2, 2, name='pool1')
         .conv(1, 1, 256, 1, 1, biased=False, relu=False, name='res2a_branch1')
