...
def main():
    ...
    net = stop_gradient_structured_attention_DeepLabResNetModel({'data': image_batch}, is_training=args.is_training, num_classes=args.num_classes)
    ...
    loss_sigmoid1_summary = tf.summary.scalar('loss_sigmoid1', tf.reduce_mean(loss_sigmoid1))
    loss_sigmoid2_summary = tf.summary.scalar('loss_sigmoid2', tf.reduce_mean(loss_sigmoid2))
