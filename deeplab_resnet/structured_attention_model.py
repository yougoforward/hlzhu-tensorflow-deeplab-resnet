...
class structured_attention_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('fc1_voc12_c0',
                   ...
                   'fc1_voc12_c3')
         .add(name='fc1_voc12')
         .sigmoid(name='fc1_voc12_sigmoid'))

        (self.feed('res5c_relu')
         .conv(1, 1, 512, 1, 1, biased=False, relu=False, name='res5c_reduce_decoder'))

        (self.feed('res4b22_relu')
         .conv(3, 3, 512, 1, 1, biased=False, relu=True, name='res4b22_skip_decoder'))

        (self.feed('res4b22_skip_decoder',
                   'res5c_reduce_decoder',
                   'fc1_voc12_sigmoid')
         .concat(3, name='concat1_decoder'))

        (self.feed('concat1_decoder')
         .conv(3, 3, 512, 1, 1, biased=False, relu=True, name='concat1_reduce_decoder'))

        (self.feed('concat1_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 6, padding='SAME', relu=False, name='fc2_voc12_c0'))

        (self.feed('concat1_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 12, padding='SAME', relu=False, name='fc2_voc12_c1'))

        (self.feed('concat1_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 18, padding='SAME', relu=False, name='fc2_voc12_c2'))

        (self.feed('concat1_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 24, padding='SAME', relu=False, name='fc2_voc12_c3'))

        (self.feed('fc2_voc12_c0',
                   'fc2_voc12_c1',
                   'fc2_voc12_c2',
                   'fc2_voc12_c3')
         .add(name='fc2_voc12')
         .sigmoid(name='fc2_voc12_sigmoid'))

        (self.feed('concat1_reduce_decoder')
         .conv(1, 1, 256, 1, 1, biased=False, relu=True, name='concat1_reduce2_decoder'))

        (self.feed('res3b3_relu')
         .conv(3, 3, 256, 1, 1, biased=False, relu=True, name='res3b3_skip_decoder'))

        (self.feed('res3b3_skip_decoder',
                   'concat1_reduce2_decoder',
                   'fc2_voc12_sigmoid')
         .concat(3, name='concat2_decoder'))

        (self.feed('concat2_decoder')
         .conv(3, 3, 256, 1, 1, biased=False, relu=True, name='concat2_reduce_decoder'))

        (self.feed('concat2_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 6, padding='SAME', relu=False, name='fc3_voc12_c0'))

        (self.feed('concat2_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 12, padding='SAME', relu=False, name='fc3_voc12_c1'))

        (self.feed('concat2_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 18, padding='SAME', relu=False, name='fc3_voc12_c2'))

        (self.feed('concat2_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 24, padding='SAME', relu=False, name='fc3_voc12_c3'))

        (self.feed('fc3_voc12_c0',
                   'fc3_voc12_c1',
                   'fc3_voc12_c2',
                   'fc3_voc12_c3')
         .add(name='fc3_voc12'))

class scorerefine_structured_attention_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('fc1_voc12_c0',
                   ...
                   'fc1_voc12_c3')
         .add(name='fc1_voc12')
         .softmax(name='fc1_voc12_softmax'))
        ...
        (self.feed('fc2_voc12_c0',
                   ...
                   'fc2_voc12_c3')
         .add(name='fc2_voc12')
         .softmax(name='fc2_voc12_softmax'))
        ...
        (self.feed('fc3_voc12_c0',
                   ...
                   'fc3_voc12_c3')
         .add(name='fc3_voc12'))
class stop_gradient_structured_attention_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('fc1_voc12_c0',
         ...
         .add(name='fc1_voc12')
         .sigmoid(name='fc1_voc12_sigmoid')
         .stop_gradient(name='fc1_voc12_sigmoid_stop_gradient'))
        ...
        (self.feed('res4b22_skip_decoder',
                   'res5c_reduce_decoder',
                   'fc1_voc12_sigmoid_stop_gradient')
         .concat(3, name='concat1_decoder'))
        ...
        (self.feed('fc2_voc12_c0',
         ...
         .add(name='fc2_voc12')
         .sigmoid(name='fc2_voc12_sigmoid')
         .stop_gradient(name='fc2_voc12_sigmoid_stop_gradient'))
        ...
        (self.feed('res3b3_skip_decoder',
                   'concat1_reduce2_decoder',
                   'fc2_voc12_sigmoid_stop_gradient')
         .concat(3, name='concat2_decoder'))
        ...
        (self.feed('fc3_voc12_c0',
                   ...
                   'fc3_voc12_c3')
         .add(name='fc3_voc12'))
class add_concat_structured_attention_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('res4b22_skip_decoder',
                   'res5c_reduce_decoder')
         .add(name='add1_decoder'))

        (self.feed('add1_decoder',
                   'fc1_voc12_sigmoid')
         .concat(3, name='concat1_decoder'))
        ...
        (self.feed('res3b3_skip_decoder',
                   'concat1_reduce2_decoder')
         .add(name='add2_decoder'))

        (self.feed('add2_decoder',
                   'fc2_voc12_sigmoid')
         .concat(3, name='concat2_decoder'))
        ...
        (self.feed('fc3_voc12_c0',
                   ...
                   'fc3_voc12_c3')
         .add(name='fc3_voc12'))
class add_concat_scorerefine_structured_attention_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
...
class structured_attention_concat2conv_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('res4b22_skip_decoder',
         ...
         .concat(3, name='concat1_decoder'))
        (self.feed('concat1_decoder')
         .conv(3, 3, 512, 1, 1, biased=False, relu=True, name='concat1_reduce0_decoder'))
        (self.feed('concat1_reduce0_decoder')
         .conv(3, 3, 512, 1, 1, biased=False, relu=True, name='concat1_reduce_decoder'))
        ...
        (self.feed('res3b3_skip_decoder',
         ...
         .concat(3, name='concat2_decoder'))
        (self.feed('concat2_decoder')
         .conv(3, 3, 256, 1, 1, biased=False, relu=True, name='concat2_reduce0_decoder'))
        (self.feed('concat2_reduce0_decoder')
         .conv(3, 3, 256, 1, 1, biased=False, relu=True, name='concat2_reduce_decoder'))
        ...
        (self.feed('fc3_voc12_c0',
                   ...
                   'fc3_voc12_c3')
         .add(name='fc3_voc12'))
class add_concat_structured_attention_concat2conv_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('fc3_voc12_c0',
                   ...
                   'fc3_voc12_c3')
         .add(name='fc3_voc12'))
class add_concat_scorerefine_structured_attention_concat2conv_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('fc3_voc12_c0',
                   ...
                   'fc3_voc12_c3')
         .add(name='fc3_voc12'))
class scorerefine_structured_attention_concat2conv_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
...
class structured_attention_before_softmax_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('fc3_voc12_c0',
                   ...
                   'fc3_voc12_c3')
         .add(name='fc3_voc12')
         .sigmoid(name='fc3_voc12_sigmoid'))

        (self.feed('concat2_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 6, padding='SAME', relu=False, name='fc4_voc12_c0'))

        (self.feed('concat2_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 12, padding='SAME', relu=False, name='fc4_voc12_c1'))

        (self.feed('concat2_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 18, padding='SAME', relu=False, name='fc4_voc12_c2'))

        (self.feed('concat2_reduce_decoder')
         .atrous_conv(3, 3, num_classes, 24, padding='SAME', relu=False, name='fc4_voc12_c3'))

        (self.feed('fc4_voc12_c0',
                   'fc4_voc12_c1',
                   'fc4_voc12_c2',
                   'fc4_voc12_c3')
         .add(name='fc4_voc12'))

        (self.feed('fc1_voc12_sigmoid',
                   'fc2_voc12_sigmoid',
                   'fc3_voc12_sigmoid')
         .add(name='fc_sigmoid_fusion'))
        (self.feed('fc_sigmoid_fusion',
                   'fc4_voc12')
         .eltwisemul(name='fc_attentioned_prediction'))

class structured_attention_finalscale_before_softmax_DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
