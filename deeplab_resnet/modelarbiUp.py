...
class DeepLabResNetModelarbiUpOri(Network):
    def setup(self, is_training, num_classes):
        ...
        # (n,h,w,c)(0,1,2,3) to (n,c,w,h)(0,3,2,1)
        # (n,c,w,h)(0,1,2,3) to (n,c,h,w)(0,1,3,2)
        # (n,c,h,w)(0,1,2,3) to (n,h,w,c)(0,2,3,1)
        (self.feed('fc1_voc12')
         .transpose(perm=[0, 3, 2, 1], name='transpose_h_c')
         .conv(1, 1, 41, 1, 1, biased=False, relu=False, name='transposehc_conv')
         .relu(name='transposehc_conv_relu')
         .transpose(perm=[0, 1, 3, 2], name='transpose_w_h')
         .conv(1, 1, 41, 1, 1, biased=False, relu=False, name='transposewh_conv')
         .relu(name='transposewh_conv_relu')
         .transpose(perm=[0, 2, 3, 1], name='transpose_back')
         )


class DeepLabResNetModelarbiUp(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('fc1_voc12')
         .transpose(perm=[0, 3, 2, 1], name='transpose_h_c')
         .depthwise_conv(3, 3, strides=[1, 1, 1, 1], padding='SAME', multiplyer=2, name='depthwiseUph')
         .relu(name='transposehc_conv_relu')
         .transpose(perm=[0, 1, 3, 2], name='transpose_w_h')
         .depthwise_conv(3, 3, strides=[1, 1, 1, 1], padding='SAME', multiplyer=2, name='depthwiseUpw')
         .relu(name='transposewh_conv_relu')
         .transpose(perm=[0, 2, 3, 1], name='transpose_back')
         .conv(3, 3, num_classes, 1, 1, biased=False, relu=False, name='transpose_back_conv')
         )

class DeepLabResNetModelDepthwiseUp(Network):
    def setup(self, is_training, num_classes):
        '''Network definition.
        ...
        (self.feed('res5b_relu',
         ...
         .add(name='res5c')
         .relu(name='res5c_relu')
         .atrous_conv(3, 3, num_classes*2, 6, padding='SAME', relu=False, name='fc1_voc12_c0'))

        (self.feed('res5c_relu')
         .atrous_conv(3, 3, num_classes*2, 12, padding='SAME', relu=False, name='fc1_voc12_c1'))

        (self.feed('res5c_relu')
         .atrous_conv(3, 3, num_classes*2, 18, padding='SAME', relu=False, name='fc1_voc12_c2'))

        (self.feed('res5c_relu')
         .atrous_conv(3, 3, num_classes*2, 24, padding='SAME', relu=False, name='fc1_voc12_c3'))
        ...
        (self.feed('fc1_voc12')
         .transpose(perm=[0, 3, 2, 1], name='transpose_h_c')
         .depthwise_conv(1, 1, strides=[1, 1, 1, 1], padding='SAME', multiplyer=2, name='depthwiseUph')
         .relu(name='transposehc_conv_relu')
         .transpose(perm=[0, 1, 3, 2], name='transpose_w_h')
         .depthwise_conv(1, 1, strides=[1, 1, 1, 1], padding='SAME', multiplyer=2, name='depthwiseUpw')
         .relu(name='transposewh_conv_relu')
         .transpose(perm=[0, 2, 3, 1], name='transpose_back')
         .conv(5, 5, num_classes, 1, 1, biased=False, relu=False, name='transpose_back_conv')
         )
