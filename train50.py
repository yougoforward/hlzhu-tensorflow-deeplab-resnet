...
from deeplab_resnet import DeepLabResNetModelOri50, ImageReader, decode_labels, inv_preprocess, prepare_label, DeepLabResNetModelOri50gcn, DeepLabResNetModelOri50gcnaspp
...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = './resnet50/init50gcnaspp.ckpt'
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 1000
SNAPSHOT_DIR = './snapshots50gcnaspp/'
WEIGHT_DECAY = 0.0005
