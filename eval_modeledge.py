...
from deeplab_resnet import DeepLabResNetModel, ImageReader, prepare_label, DeepLabResNetModel, DeepLabResNetModelOri50, \
    DeepLabResNetModelOri50gcnaspp, DeepLabResNetModelDepthwiseUp, DeepLabResNetModeledge
...
def main():
    ...
    # Create network.
    net = DeepLabResNetModeledge({'data': image_batch}, is_training=False, num_classes=args.num_classes)
