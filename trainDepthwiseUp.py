...
from deeplab_resnet import DeepLabResNetModel, ImageReader, decode_labels, inv_preprocess, prepare_label, \
    DeepLabResNetModelarbiUp, DeepLabResNetModelDepthwiseUp
...
RANDOM_SEED = 1234
RESTORE_FROM = None
    #'./deeplab_resnet/deeplab_resnet_init.ckpt'
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 1000
SNAPSHOT_DIR = './snapshots/depthwiseUp84conv1x1_5/'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    # Create network.
    net = DeepLabResNetModelDepthwiseUp({'data': image_batch}, is_training=args.is_training, num_classes=args.num_classes)
    ...
    restore_var = [v for v in tf.global_variables() if 'transpose' not in v.name and 'depthwise' not in v.name and 'fc' not in v.name]
